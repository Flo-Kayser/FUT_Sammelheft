...
<section class="mt-auto" style={`color: #${cardVersion?.textColor[0]}`}>
	...
	{#if totalPages > 1}
		...
		<div class="my-4 flex justify-center gap-2 items-center">
			...
			<a
				...
				class="rounded border px-3 py-1 hover:brightness-150" 
			...
			{#each pagesToShow as page, i}
				...
				<a
					...
					class="rounded border w-10 py-1 text-center hover:brightness-150 "
