...
<div class="min-h-screen backdrop-blur-xl select-none">
	<div
		class="absolute top-3 right-8 flex flex-col items-end gap-2 rounded-md bg-amber-500/60 px-4 py-2 text-3xl font-black text-white"
	>
		<span>
	...
	<section class="grid grid-cols-3 gap-4 px-8 pb-4">
		<input
			...
			class="col-start-3 w-full rounded-md bg-amber-500/60 px-4 py-2 text-lg font-bold outline-none"
		/>
	</section>
